...
import com.sandi.client.application.north.NorthPresenter;
import com.sandi.client.application.south.SouthPresenter;
import com.sandi.client.application.west.WestPresenter;
...
public class ApplicationPresenter extends Presenter<ApplicationPresenter.MyView, ApplicationPresenter.MyProxy> {
    ...
    @ContentSlot
    public static final Type<RevealContentHandler<?>> SLOT_SetSouth = new Type<RevealContentHandler<?>>();
    @ContentSlot
    ...
    private SouthPresenter southPresenter;
    ...
    @Inject
    public ApplicationPresenter(EventBus eventBus, MyView view, MyProxy proxy,SouthPresenter southPresenter,
    		NorthPresenter northPresenter, WestPresenter westPresenter) {
